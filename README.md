...
|---|---|---|---|
| 🔵 [Langfuse](https://github.com/langfuse/langfuse) | 32.4k | MIT (open-core) | AI engineering platform: tracing, evals, prompt mgmt, playground. The most widely adopted OSS LLM-obs platform. |
| 🟢 [MLflow](https://github.com/mlflow/mlflow) | 27.3k | Apache-2.0 | The ML platform, now with first-class LLM/agent **tracing & evaluation**. |
| 🟢 [Comet Opik](https://github.com/comet-ml/opik) | 21.1k | Apache-2.0 | Trace, evaluate & monitor LLM/RAG/agent apps; automated prompt optimization. |
| 🟢 [Microsoft PromptFlow](https://github.com/microsoft/promptflow) | 11.2k | MIT | Build, test, deploy & monitor LLM apps end-to-end. |
| 🟢 [Arize Phoenix](https://github.com/Arize-ai/phoenix) | 10.9k | Elastic v2 | OpenTelemetry-native AI observability & evaluation; runs locally or self-hosted. |
...
| 🟠 [LangSmith](https://github.com/langchain-ai/langsmith-sdk) | 996 (SDK) | MIT (SDK) | Tracing/eval platform from LangChain; SDK is OSS, backend commercial. |
| 🟠 [Datadog LLM Observability](https://github.com/DataDog/dd-trace-py) | 645 (tracer) | BSD-3 | LLM Observability product on top of Datadog APM. |
...
| Tool | ⭐ | License | Description |
|---|---|---|---|
| 🟢 [promptfoo](https://github.com/promptfoo/promptfoo) | 23.9k | MIT | Test/eval prompts, agents & RAG; red-teaming and CI/CD. |
| 🟢 [OpenAI Evals](https://github.com/openai/evals) | 19.1k | MIT | Framework + registry of benchmarks for evaluating LLMs. |
| 🟢 [DeepEval](https://github.com/confident-ai/deepeval) | 17.4k | Apache-2.0 | "Pytest for LLMs" - 40+ metrics for LLM output evaluation. |
| 🟢 [Ragas](https://github.com/vibrantlabsai/ragas) | 15.1k | Apache-2.0 | Evaluation toolkit for LLM/RAG applications. |
| 🟢 [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) | 13.5k | MIT | Few-shot benchmark evaluation of language models (EleutherAI). |
...
| Tool | ⭐ | License | Description |
|---|---|---|---|
| 🟢 [Agenta](https://github.com/Agenta-AI/agenta) | 4.4k | MIT | LLMOps platform: prompt playground, versioning, eval & observability. |
| 🟢 [Pezzo](https://github.com/pezzolabs/pezzo) | 3.3k | Apache-2.0 | Developer-first prompt design, versioning & observability. |
| 🟠 [PromptLayer](https://github.com/MagnivOrg/prompt-layer-library) | 782 | Apache-2.0 | Log, track, debug & replay prompts and LLM requests. |
...
| Tool | ⭐ | License | Description |
|---|---|---|---|
| 🟢 [LiteLLM](https://github.com/BerriAI/litellm) | 55.4k | MIT | Python SDK + proxy calling 100+ LLMs with unified cost tracking & logging. |
| 🟢 [Portkey Gateway](https://github.com/Portkey-AI/gateway) | 12.6k | MIT | Fast AI gateway routing to 1,600+ LLMs with built-in guardrails & observability. |
...
| 🟢 [Bifrost](https://github.com/maximhq/bifrost) | 7.0k | Apache-2.0 | Fast AI gateway routing to 1,000+ models with logging, cost tracking & governance. |
...
| 🟢 [OTel Semantic Conventions](https://github.com/open-telemetry/semantic-conventions) | 624 | Apache-2.0 | Home of the **GenAI semantic conventions** spec (`gen_ai.*`). |
...
| 🟢 [Presidio](https://github.com/data-privacy-stack/presidio) | 10.3k | MIT | PII detection, redaction & anonymization; the standard for scrubbing prompts and traces. |
