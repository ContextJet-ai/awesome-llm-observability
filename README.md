...
|---|---|---|---|
| 🔵 [Langfuse](https://github.com/langfuse/langfuse) | 31.9k | MIT (open-core) | AI engineering platform: tracing, evals, prompt mgmt, playground. The most widely adopted OSS LLM-obs platform. |
| 🟢 [MLflow](https://github.com/mlflow/mlflow) | 27.2k | Apache-2.0 | The ML platform, now with first-class LLM/agent **tracing & evaluation**. |
| 🟢 [Comet Opik](https://github.com/comet-ml/opik) | 20.9k | Apache-2.0 | Trace, evaluate & monitor LLM/RAG/agent apps; automated prompt optimization. |
| 🟢 [Microsoft PromptFlow](https://github.com/microsoft/promptflow) | 11.2k | MIT | Build, test, deploy & monitor LLM apps end-to-end. |
| 🟢 [Arize Phoenix](https://github.com/Arize-ai/phoenix) | 10.8k | Elastic v2 | OpenTelemetry-native AI observability & evaluation; runs locally or self-hosted. |
...
| 🟠 [LangSmith](https://github.com/langchain-ai/langsmith-sdk) | 987 (SDK) | MIT (SDK) | Tracing/eval platform from LangChain; SDK is OSS, backend commercial. |
| 🟠 [Datadog LLM Observability](https://github.com/DataDog/dd-trace-py) | 646 (tracer) | BSD-3 | LLM Observability product on top of Datadog APM. |
...
| Tool | ⭐ | License | Description |
|---|---|---|---|
| 🟢 [promptfoo](https://github.com/promptfoo/promptfoo) | 23.6k | MIT | Test/eval prompts, agents & RAG; red-teaming and CI/CD. |
| 🟢 [OpenAI Evals](https://github.com/openai/evals) | 19.0k | MIT | Framework + registry of benchmarks for evaluating LLMs. |
| 🟢 [DeepEval](https://github.com/confident-ai/deepeval) | 17.2k | Apache-2.0 | "Pytest for LLMs" - 40+ metrics for LLM output evaluation. |
| 🟢 [Ragas](https://github.com/vibrantlabsai/ragas) | 15.0k | Apache-2.0 | Evaluation toolkit for LLM/RAG applications. |
| 🟢 [LM Evaluation Harness](https://github.com/EleutherAI/lm-evaluation-harness) | 13.4k | MIT | Few-shot benchmark evaluation of language models (EleutherAI). |
...
| 🟠 [PromptLayer](https://github.com/MagnivOrg/prompt-layer-library) | 781 | Apache-2.0 | Log, track, debug & replay prompts and LLM requests. |
...
| Tool | ⭐ | License | Description |
|---|---|---|---|
| 🟢 [LiteLLM](https://github.com/BerriAI/litellm) | 54.8k | MIT | Python SDK + proxy calling 100+ LLMs with unified cost tracking & logging. |
...
| 🟢 [Bifrost](https://github.com/maximhq/bifrost) | 6.8k | Apache-2.0 | Fast AI gateway routing to 1,000+ models with logging, cost tracking & governance. |
...
| 🟢 [OTel Semantic Conventions](https://github.com/open-telemetry/semantic-conventions) | 617 | Apache-2.0 | Home of the **GenAI semantic conventions** spec (`gen_ai.*`). |
...
| 🟢 [NeMo Guardrails](https://github.com/NVIDIA-NeMo/Guardrails) | 6.8k | Apache-2.0 | Programmable guardrails for LLM conversational systems (NVIDIA). |
...
| 🟢 [Presidio](https://github.com/data-privacy-stack/presidio) | 10.2k | MIT | PII detection, redaction & anonymization; the standard for scrubbing prompts and traces. |
| 🟢 [garak](https://github.com/NVIDIA/garak) | 8.6k | Apache-2.0 | LLM vulnerability scanner: probes for prompt injection, jailbreaks & data leakage (NVIDIA). |
