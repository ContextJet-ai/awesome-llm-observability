...
|---|---|---|---|
| 🔵 [Langfuse](https://github.com/langfuse/langfuse) | 33.6k | MIT (open-core) | AI engineering platform: tracing, evals, prompt mgmt, playground. The most widely adopted OSS LLM-obs platform. |
| 🟢 [MLflow](https://github.com/mlflow/mlflow) | 27.6k | Apache-2.0 | The ML platform, now with first-class LLM/agent **tracing & evaluation**. |
| 🟢 [Comet Opik](https://github.com/comet-ml/opik) | 21.6k | Apache-2.0 | Trace, evaluate & monitor LLM/RAG/agent apps; automated prompt optimization. |
| 🟢 [Microsoft PromptFlow](https://github.com/microsoft/promptflow) | 11.2k | MIT | Build, test, deploy & monitor LLM apps end-to-end. |
| 🟢 [Arize Phoenix](https://github.com/Arize-ai/phoenix) | 11.2k | Elastic v2 | OpenTelemetry-native AI observability & evaluation; runs locally or self-hosted. |
...
| Tool | ⭐ | License | Description |
|---|---|---|---|
| 🟢 [promptfoo](https://github.com/promptfoo/promptfoo) | 24.5k | MIT | Test/eval prompts, agents & RAG; red-teaming and CI/CD. |
| 🟢 [OpenAI Evals](https://github.com/openai/evals) | 19.2k | MIT | Framework + registry of benchmarks for evaluating LLMs. |
| 🟢 [DeepEval](https://github.com/confident-ai/deepeval) | 17.8k | Apache-2.0 | "Pytest for LLMs" - 40+ metrics for LLM output evaluation. |
| 🟢 [Ragas](https://github.com/vibrantlabsai/ragas) | 15.4k | Apache-2.0 | Evaluation toolkit for LLM/RAG applications. |
...
| 🟢 [ClawBench](https://github.com/TIGER-AI-Lab/ClawBench) | 581 | Apache-2.0 | Live-web benchmark for browser and computer-use agents: isolated runs, request interception and replayable execution traces. |
| 🔵 [agent-qa](https://github.com/vostride/agent-qa) | 960 | FSL-1.1-ALv2 | Natural-language web and mobile regression testing with persistent memory and self-healing execution. |
...
| Tool | ⭐ | License | Description |
|---|---|---|---|
| 🟢 [LiteLLM](https://github.com/BerriAI/litellm) | 57.1k | MIT | Python SDK + proxy calling 100+ LLMs with unified cost tracking & logging. |
| 🟢 [Portkey Gateway](https://github.com/Portkey-AI/gateway) | 12.8k | MIT | Fast AI gateway routing to 1,600+ LLMs with built-in guardrails & observability. |
...
| 🟢 [OTel Semantic Conventions](https://github.com/open-telemetry/semantic-conventions) | 639 | Apache-2.0 | Home of the **GenAI semantic conventions** spec (`gen_ai.*`). |
| 🟢 [WhyLabs LangKit](https://github.com/whylabs/langkit) | 993 | Apache-2.0 | Extract telemetry/metrics (quality, sentiment, injection signals) from prompts & responses. |
